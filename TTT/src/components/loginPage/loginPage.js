                        ...
                        <div id="example">
                            ...
                            <form action="#" className="form1">
                                ...
                                <div className="form-group" id="div2" style={{  }}>
                                    <input type="password" className="form-control" id="pwd" placeholder="Password" name="pwd" style={{ height: '38px', marginLeft:'-32%' }} />
                            ...
                            <Button className="btn" style={{marginLeft:'30%', width:'35%'}}>Login<ion-icon id="rightArrow" name="arrow-forward"></ion-icon></Button>
                            <br />
                            <br />
                            <br />
                            <br />
