                        ...
                        <div className="column" id="column1">
                            <div className="navPt2">
                                <ul className="nav nav-tabs" id="tabs">
                                    <li style={{ backgroundColor: '#1e1e1e', }} ><a href="#" className="Index">Index.cls-sfdx <Spacer amount={10}/></a></li>
                                    <li className="dDown">
                                        <select id="dDmenu">
                        ...
                        <div className="column" id="column2" style={{ }}>
                            <div className="div3" style={{ border: '1px solid black' }}>
                                <form>
                                    <br />
                                    <div className="Tbtn">
                                        <Spacer amount={5} /> <input type="text" placeholder="Serial Monitor" className="In"></input>
